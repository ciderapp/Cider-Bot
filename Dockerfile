...
ENTRYPOINT sh -c "if [ -d .git ]; then git reset --hard && git pull; else git clone https://github.com/ciderapp/Cider-Bot.git .; fi && pnpm install && pnpm run build && pnpm run start || true"
