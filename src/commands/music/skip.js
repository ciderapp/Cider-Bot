...
export const command = {
    ...
    execute: async (interaction) => {
        ...
        if (interaction.guildId == process.env.guildId && !interaction.author.roles.test(mod) && (queue.metadata.voteskip < 3 || interaction.guild.members.me.voice.channel.members.size < 5)) {
