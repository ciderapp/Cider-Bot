...
export const command = {
    ...
    execute: async (interaction) => {
        ...
        if (interaction.guildId == process.env.guildId && interaction.user.roles.cache.findKey(role => role.test(mod)) === undefined && (queue.metadata.voteskip < 3 || interaction.guild.members.me.voice.channel.members.size < 5)) {
